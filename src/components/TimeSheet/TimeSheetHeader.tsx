      ...
      <div className="flex gap-2">
        {firstWeek && (
          <Button
            ...
            disabled={adminOverride && (!customWeeks || customWeeks.length === 0)}
            title={adminOverride && (!customWeeks || customWeeks.length === 0) ? "No custom weeks available" : "Return to first unsubmitted week"}
          >
